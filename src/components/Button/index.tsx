...
const variants = {
  fill: {
    deep_orange_A400: "bg-deep_orange_A700 text-white-A700",
    white_A700: "bg-white-A700",
    green_700: "bg-green-700 text-white-700",
    purple_500: "bg-purple-500 text-white-700",
    gray_100: "bg-gray-100 text-black-900",
    orange_A700: "bg-orange-A700 text-white_A700",
    red_900: "bg-red-900 text-white-A700",
    gray_50: "bg-gray-50 text-black-900",
    bluegray_900: "bg-blugray-900 text-white-A700",
